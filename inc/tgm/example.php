...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		// This is an example of how to include a plugin from the WordPress Plugin Repository.
		array(
			'name'               => 'Joyous Elementor Addon', // The plugin name.
			'slug'               => 'joyous-elementor-addon', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/joyous-elementor-addon.zip', // The plugin source.
